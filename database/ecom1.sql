...
--
-- Host: 127.0.0.1
-- Generation Time: May 14, 2018 at 09:25 AM
...
--
-- Table structure for table `decreasenext`
--

CREATE TABLE `decreasenext` (
  `id` int(10) NOT NULL,
  `allprice` int(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `decreasenext`
--

INSERT INTO `decreasenext` (`id`, `allprice`) VALUES
(1, 70000);
...
(12, 4, 4, 'Oppo R9s', 19900, 'OPPO R9s\r\n\r\nDISPLAY & SENSORS\r\n	Smartphone\r\n	Display AMOLED 24-bit (True color) \r\n- Multi-Touch\r\n- Width 5.5 Inch (Diagonal)\r\n- Resolution 1080 x 1920 Pixels (401 ppi) \r\n- Capacitive \r\n- Corning Gorilla Glass\r\n	Sensor \r\n- Fingerprint Verification (Finger Print) \r\n- Accelerometer (Accelerometer) \r\n- Ambient Light Sensor (Ambient light) \r\n- Proximity Sensor \r\n- Adjust the view displayed automatically (Orientation)\r\n	Colours : Black, Gold, Rose Gold\r\nCONNECTIVITY\r\n	Location: Assisted GPS\r\n	WiFi 802.11 a/b/g/n/ac \r\n- Portable Internet hot-spots (Portable Wi-Fi Hotspot)\r\n- Wi-Fi Direct\r\n	Bluetooth 4.1 \r\n- Support for stereo headsets\r\n	Micro USB 2.0\r\n	USB On-The-Go (USB On-The-Go)\r\n	Headset /Jack 3.5 mm.\r\n', 'r9s.png', 'Oppo R9s r9s OppoR9s', 0),
(13, 1, 1, 'New iPad 9.7', 11900, 'iPad 9.7 Wi-Fi + Cellular\r\n\r\nDISPLAY & SENSORS\r\n	Tablet\r\n	Display Retina Display 24-bit (True color) \r\n- Multi-Touch\r\n- Width 9.7 Inch (Diagonal)\r\n- Resolution 1536 x 2048 Pixels (264 ppi) \r\n- Capacitive \r\n- Fingerprints Resistant\r\n	Sensor \r\n- Fingerprint Verification (Finger Print) \r\n- Motion Sensor (Accelerometer) \r\n- Three-axis Gyroscope (Three-axis gyroscope) \r\n- Built-in Barometer\r\n\r\nCONNECTIVITY\r\n	Location: Assisted GPS\r\n	WiFi 802.11 a/b/g/n/ac \r\n- Portable Internet hot-spots (Portable Wi-Fi Hotspot)\r\n	Bluetooth 4.2 \r\n- Support for stereo headsets\r\n	USB Lightning\r\n', 'ipad9.7.jpg', 'New iPad 9.7 iPad ipad Apple apple newipad ', 0),
(14, 5, 5, 'Apple AirPods', 6990, 'Bluetooth\r\n\r\nWireless\r\n\r\nWeight\r\nAirPods (each): 0.14 ounces (4 g)\r\n\r\nCharging Case: 1.34 ounces (38 g)\r\n\r\nDimensions\r\nAirPods (each): 0.65 by 0.71 by 1.59 inches (16.5 by 18.0 by 40.5 mm)\r\n\r\nCharging Case: 1.74 by 0.84 by 2.11 inches (44.3 by 21.3 by 53.5 mm)\r\n\r\nConnections\r\nAirPods: Bluetooth\r\n\r\nCharging Case: Lightning connector\r\n\r\nAirPods Sensors (each):\r\nDual beam-forming microphones\r\n\r\nDual optical sensors\r\n\r\nMotion-detecting accelerometer\r\n\r\nSpeech-detecting accelerometer\r\n\r\nPower and Battery\r\nAirPods with Charging Case: More than 24 hours listening time, up to 11 hours talk time\r\n\r\nAirPods (single charge): Up to 5 hours listening time, Up to 2 hours talk time\r\n\r\n15 minutes in the case equals 3 hours listening time or over an hour of talk time', 'airpod.png', 'AppleAirPods Apple AirPods apple airpods', 0),
(15, 5, 5, 'Apple Pencil', 3900, 'Apple Pencil expands the power of iPad Pro and iPad (6th generation) and opens up new creative possibilities. Its sensitive to pressure and tilt so you can easily vary line weight create subtle shading, and produce a wide range of artistic effects  just like a conventional pencil, but with pixel-perfect precision.\r\n\r\nDimensions\r\n\r\nLength: 6.92 inches (175.7 mm) measured from tip to cap\r\n\r\nDiameter: 0.35 inch (8.9 mm)\r\n\r\nWeight: 0.73 ounce (20.7 grams)\r\n\r\nConnections\r\nBluetooth\r\n\r\nLightning connector\r\n\r\nOther Features\r\nMagnetically attached cap', 'apple pencil.png', 'Apple Pencil apple pencil', 0),
(16, 5, 5, 'Case for iPad Pro 12.9', 1290, 'Protect your iPad', 'case ipad pro.png', 'CaseiPad Pro 12.9 case ipad', 0),
(17, 5, 5, 'Case for iPad Pro 10.5', 1290, 'Protect Your iPad', 'case ipad proten.png', 'Case iPad Pro 10.5', 0),
(18, 5, 5, 'Case for iphone 8', 990, 'protect your iphone', 'case iphone eight.png', 'Case iphone 8 case', 0),
(19, 5, 5, 'Case for iphone 8+', 990, 'protect your iphone', 'Case iphone eight plus.png', 'Case iphone 8+ case', 0),
(20, 5, 5, 'Case for Note 8', 890, 'protect your phone', 'case note8.jpg', 'Case Note 8 case ', 0),
(21, 5, 5, 'Case for Galaxy S9+', 890, 'protect your phone', 'case s9+.png', 'Case Galaxy S9+ case', 0),
(22, 5, 5, 'Case for Galaxy S9', 890, 'protect your phone', 'case s9.png', 'Case Galaxy S9 case', 0),
(23, 5, 5, 'Case for Oppo R9s Plus', 790, 'protect your phone', 'case r9s plus.jpg', 'Case Oppo R9s Plus case r9s+  R9s+', 0),
(24, 5, 5, 'Case for Oppo R9s', 790, 'protect your phone', 'case r9s.jpg', 'Case Oppo R9s case r9s  R9s', 0),
(25, 5, 5, 'Case for Huawei P20 Pro', 1190, 'protect your phone', 'case p20pro.jpg', 'Case Huawei P20 Pro p20 case huawei', 0),
(50, 6, 0, 'PChana Phone', 1000000, 'PChana', '007.png', 'PChana', 0);
...
INSERT INTO `promotion` (`id`, `freedelivery`, `decreasenext`) VALUES
(1, 10, 0),
(2, 10, 0),
(3, 20, 0),
(4, 499, 0),
...
--
-- Table structure for table `text_promotion`
--

CREATE TABLE `text_promotion` (
  `t_id` int(99) NOT NULL,
  `news` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `text_promotion`
--

INSERT INTO `text_promotion` (`t_id`, `news`) VALUES
(1, 'Sale Apple 50% !!!');
...
(1, 'PChana', 'M.', 'superhipee@hotmail.com', '25f9e794323b453885f5181f1b624d0b', '0864562591', 'Hope Of Korat', 'admin', 0),
(2, 'asdasd', 'asdasd', 'subaddmin@hotmail.com', '25f9e794323b453885f5181f1b624d0b', '0123456789', '23148asdasdasd', 'user', 0),
(3, 'mos', 'mosmos', 'mos@hotmail.com', 'd55628b1cf599c77145102a5deacf590', '0888888888', 'mos 123/7', 'user', 0),
(4, 'fongfong', 'naruk', 'fong@hotmail.com', '25f9e794323b453885f5181f1b624d0b', '0111111111', 'fongfong4/7', 'user', 0),
(5, 'pee', 'porpee', 'thanapatza2011@hotmail.com', '25f9e794323b453885f5181f1b624d0b', '0987654321', 'qwertyuiopsdfghjklxcvbnm', 'admin', 6),
(6, 'PCNW', 'M', 'sup@hotmail.com', '25f9e794323b453885f5181f1b624d0b', '0888888888', '123/12312313', 'user', 0);
...
--
-- Indexes for table `decreasenext`
--
ALTER TABLE `decreasenext`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `text_promotion`
--
ALTER TABLE `text_promotion`
...
--
-- AUTO_INCREMENT for table `decreasenext`
--
ALTER TABLE `decreasenext`
...
--
-- AUTO_INCREMENT for table `text_promotion`
--
ALTER TABLE `text_promotion`
  MODIFY `t_id` int(99) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
