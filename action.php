...
if(isset($_POST["category"])){
	...
	*/
	...
	// OO STYLE
	$category_query = "SELECT * FROM categories";
	$run_query = $con->query($category_query) or die($con->connect_error);
	...
	";
			if ( $run_query->num_rows > 0 ){
				...
				printf("</div>", $run_query->num_rows);
}


if(isset($_POST["brand"])){
	$brand_query = "SELECT * FROM brands";
	$run_query = $con->query($brand_query) or die($con->connect_error);
	echo "
		<div class='nav nav-pills nav-stacked'>
...
if(isset($_POST["page"])){
	...
	$run_query = $con->query($sql) or die($con->connect_error);
	$count = $run_query->num_rows;
	$pageno = ceil($count/9);
	for($i=1;$i<=$pageno;$i++){
		echo "
...
if(isset($_POST["get_seleted_Category"]) || isset($_POST["selectBrand"]) || isset($_POST["search"])){
	...
	if(isset($_POST["addToCart"])){
		...
		if($count > 0){
			...
			if($con->query($sql) or die($con->connect_error)){
				echo "
